...
| Options websocket parity | Partial | N/A | Deribit and Bybit public WS ticker updates the option cache; REST chain/depth coverage is wired. OKX/Binance low-latency WS parity remains tracked in `docs/feature_inventory.md`. |
...
and remaining OKX/Binance options websocket parity. Aggregator analytics for funding divergence, OI
