...
const ROADMAP: &[RoadmapSource] = &[
    ...
    RoadmapSource {
        ...
        marketbridge_status: "planned",
        priority: "P2",
        notes: "Hummingbot perp connector exists; inspect public data depth before implementation.",
    },
    RoadmapSource {
        source: "decibel",
        source_type: "exchange",
    ...
    RoadmapSource {
        ...
        marketbridge_status: "planned",
        priority: "P1",
        notes: "Hummingbot Gateway active CLMM connector; add DLMM pool state and quote snapshots.",
    },
    RoadmapSource {
        source: "raydium",
        source_type: "defi_venue",
