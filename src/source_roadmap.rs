...
const ROADMAP: &[RoadmapSource] = &[
    ...
    RoadmapSource {
        ...
        marketbridge_status: "implemented",
        priority: "P0",
        notes: "Public CLOB spot/perp book-depth and trade streams wired for known product ids; gateway all_products emits OI and archive funding_rates emits funding. Public liquidation feed is unavailable.",
    },
    RoadmapSource {
        source: "xrpl",
        source_type: "exchange",
    ...
    RoadmapSource {
        ...
        marketbridge_status: "partial",
        priority: "P1",
        notes: "Public perp order books/trades wired over WS; funding, instrument BBO, and instrument open interest via REST.",
    },
    RoadmapSource {
        source: "architect",
        source_type: "exchange",
