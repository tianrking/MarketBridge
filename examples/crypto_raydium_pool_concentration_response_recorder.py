#!/usr/bin/env python3
"""Record Raydium pool states beside a synchronized MarketBridge quote."""
...
def main():
    ...
    parser.add_argument("--output", type=Path,
                        default=Path("work/crypto-raydium-pool-concentration-response.jsonl"))
    ...
    parameters = {
        ...
        "price_symbol": args.price_symbol.upper(),
    ...
    with args.output.open("a", encoding="utf-8") as handle:
        for iteration in range(args.iterations):
            ...
            quote_payload = fetch(args.base_url, "/v1/market/quotes", {
                "symbols": args.price_symbol,
                "exchanges": args.price_exchange,
                "product_type": args.product_type,
                "include_stale": "false",
            }, args.timeout)
            handle.write(json.dumps({
                ...
                "observation": {
                    ...
                    "pool_count": pools.get("pool_count", 0),
    ...
    print(json.dumps({
        "strategy": "crypto_raydium_pool_concentration_response_recorder",
