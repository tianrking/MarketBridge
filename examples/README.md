...
| `crypto/microstructure/crypto_account_ratio_oi_response_replay.py` | Bybit holder-count long/short imbalance with rising or falling OI may separate crowding and unwinding response states | `/v1/history/account-ratio`, `/v1/history/open-interest`, `/v1/history/candles` | Holder percentages are not notional positions; cursor coverage, alignment, costs and execution remain explicit |
