#!/usr/bin/env python3
"""Record Fear & Greed and MarketBridge price snapshots as JSONL."""
...
from crypto_sentiment_extremes_monitor import observe  # noqa: E402
...
def main():
    ...
    parser.add_argument("--interval-secs", type=float, default=86400.0)
    parser.add_argument("--timeout", type=float, default=30.0)
    parser.add_argument("--output", type=Path, default=Path("work/crypto-sentiment-extremes.jsonl"))
    args = parser.parse_args()
    if (not 0 <= args.fear_max < args.greed_min <= 100 or args.iterations <= 0
    ...
    parameters = {
        ...
        "product_type": args.product_type, "fear_max": args.fear_max,
        "greed_min": args.greed_min,
    }
    ...
    print(json.dumps({
        "strategy": "crypto_sentiment_extremes_recorder",
