#!/usr/bin/env python3
"""Record triangular quote-consistency snapshots to JSONL."""
...
def main():
    ...
    parser.add_argument("--output", type=Path, default=Path("work/crypto-triangular-arbitrage.jsonl"))
    ...
    print(json.dumps({
        "strategy": "crypto_triangular_arbitrage_recorder",
