...
| [`microstructure/`](microstructure/README.md) | Squeeze, exhaustion, CVD divergence, quarter-hour/session/LVN confluence, aggregate derivatives sentiment, liquidation and liquidity stress / 逼空、衰竭、CVD 背离、季度小时/时段/LVN 共振、衍生品聚合情绪、清算与流动性压力 | `short_squeeze_monitor.py`, `crypto_cvd_divergence_replay.py` |
