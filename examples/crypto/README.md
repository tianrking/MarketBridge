...
| [`universe/`](universe/README.md) | Cross-asset ranking, volatility adjustment, parameter sweeps and opportunity discovery / 跨资产排名、波动率调整、参数扫描与机会发现 | momentum replays, sweep and universe scan |
