...
|---|---|---|
| [`carry/`](carry/README.md) | Basis, funding, cross-sectional funding, cross-venue gaps, order-book edges and convergence / 基差、资金费率、横截面资金费率、跨交易所价差、盘口 edge 与收敛 | `basis_carry_monitor.py`, funding replays |
