...
| [`sentiment/`](sentiment/README.md) | Fear & Greed extremes, CryptoPanic news attention, keyed social signals and fixed-horizon response replays / Fear & Greed 极值、CryptoPanic 新闻注意力、keyed 社交指标与固定窗口响应回放 | sentiment monitors and recorders |
