...
| Predicted funding estimates | `/v1/market/predicted-funding` | none | Keyless Hyperliquid `predictedFundings`; venue labels and next funding timestamps stay explicit, not settled cash flow |
...
| DefiLlama yields | Pool APY, TVL, base/reward yield and stablecoin flags | `/v1/external/defi-yields` | keyless public | n/a |
| Deribit volatility index | Public volatility-index OHLC candles | `/v1/history/volatility-index` | keyless public | n/a |
...
| Source | Scope | Endpoint | Key | Notes |
|---|---|---|---|---|
| mempool.space | Bitcoin difficulty and hashrate | `/v1/onchain/mining`, `/v1/history/mining` | keyless | On-demand snapshot plus bounded hashrate/difficulty history; estimates do not identify miner profitability or capitulation. |
